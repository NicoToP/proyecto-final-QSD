...
export function UserPage() {
  ...
  const mensaje = () => {
    if (componentActive == "")
      return <h2 className="text-center bg-primary bg-opacity-25 p-3 rounded-3">No has seleccionado ninguna pestaña</h2>;
  ...
  return (
    <>
      <div className="row">
        ...
        <p className="fs-5 text-center fw-bold bg-primary rounded-3 p-2 bg-opacity-25">¿Qué deseas hacer?</p>
